			...
			<div class="col-sm-9 col-md-10 main">
				...
				<h1>Edit Locomotive</h1>
					<?php
						...
						echo $this->Form->input('Description',array('default'=>$stackcar_v['Locomotive']['Description']));
						echo $this->Form->input('Length',array('default'=>$stackcar_v['Locomotive']['Length']));
